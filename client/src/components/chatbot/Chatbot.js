...
class Chatbot extends Component {
    ...
    try {
      ...
      says = {
        ...
        msg: {
          text: {
            text:
              " Hey,I am having some issues.I will be back soon."
          }
        }
      };
  ...
  handleQuickReplyPayload(event, payload, text) {
    ...
    switch (payload) {
      case "recommend_yes":
        this.df_event_query("Do you have any sale going on");
        break;
      case "Thinkpad":
        this.df_event_query("Thinkpad");
        break;
      default:
            ...
            <div style={{ overflow: "hidden" }}>
              <div className="col s2">
                <a
                  ...
                  style={{ background: "darkblue"},{width:"80px"},{float:"left"},{text:"10px"}}
                  href="#"
                >
                  {message.speaks}
                </a>
